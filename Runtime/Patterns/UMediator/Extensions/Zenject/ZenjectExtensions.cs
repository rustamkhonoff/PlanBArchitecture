...
namespace UMediator.Extensions.Zenject
{
    public static class ZenjectExtensions
    {
        ...
        private static void AddUMediator(this DiContainer diContainer, UMediatrConfiguration configuration)
        {
            ...
            IUMediatrHandlersCollection collection = HandlersScanner.ScanHandlers(configuration.TargetAssemblies);
            diContainer
